...
BEGIN
    ...
    -- Add QueryType column if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('PLS.QueryMaster') AND name = 'QueryType')
    BEGIN
        ALTER TABLE [PLS].[QueryMaster] ADD [QueryType] VARCHAR(50) NOT NULL DEFAULT 'Grid';
    END
END
GO
